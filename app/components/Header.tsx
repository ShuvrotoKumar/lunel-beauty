...
const Header = () => {
  ...
  return (
    <header className="sticky top-0 z-50 bg-[#2b2b2b] backdrop-blur-md shadow-sm min-h-12 transition-all duration-300">
      <div className="container mx-auto px-4 py-3">
        <div className="flex flex-col items-center py-4 bg-[#2b2b2b] text-gray-200">
          {/* Logo with leaf icon */}
          <Link href="/" className="flex flex-col items-center mb-4" onClick={handleNavigation}>
            <FaLeaf className="text-xl text-gray-300 mb-1" />
            <span className="text-2xl font-serif tracking-wide">LUNÉL</span>
          </Link>
