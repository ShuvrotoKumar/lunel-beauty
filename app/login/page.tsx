    ...
    <div className="min-h-screen bg-[#272727] flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <p className="mt-2 text-center text-sm text-gray-100">
          Or{' '}
          <Link href="/register" className="font-medium text-[#FF9494] hover:text-[#ff7a7a]">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                <input
                  ...
                  name="remember-me"
                  type="checkbox"
                  className="h-4 w-4 text-gray-100 focus:ring-[#FF9494] border-gray-300 rounded"
                />
              ...
              <div className="text-sm">
                <a href="#" className="font-medium text-[#FF9494] hover:text-[#ff7a7a]">
